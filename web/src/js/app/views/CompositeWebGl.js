(function () {
    ...
    cinema.viewFactory.registerView('composite-image-stack-depth', 'view-webgl', function (rootSelector, viewType, model) {
        var container = $(rootSelector),
            ...
            renderer = new cinema.views.VisualizationWebGlCanvasWidget({
