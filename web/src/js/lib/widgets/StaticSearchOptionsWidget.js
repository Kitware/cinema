cinema.views.StaticSearchOptionsWidget = Backbone.View.extend({
    events: {
    ...
    initialize: function (settings) {
        ...
        this.toolbarView = new cinema.views.StaticSearchToolsToolbar({el: $(this.toolbarSelector, this.toolbarRootView) });
