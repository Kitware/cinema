...
resolution = 500
output_working_dir = '/home/scott/Documents/cinemaDemo/simpleCinemaWebGL/cam5/volume_tent'
...
description = '''
              Use a tent-shaped transfer function to volume render temperature data.
              '''
